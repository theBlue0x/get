...
echo ""
echo -e "You can view your wallet here -> http://${wanIp}:6876 "
echo ""
echo -e "If you are on a local network, you can view your " 
echo -e "wallet here -> http://${lanIp}:6876 "
echo ""
echo -e "To stop Blue0x, run 'sudo docker stop blue0x_container'."
echo ""
echo -e "You are all done. You may close this window. ${NC}"
